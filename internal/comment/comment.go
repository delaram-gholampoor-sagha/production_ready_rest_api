...
// Hey Steven, I'm a fellow learner too. I'd like to point out that the compiler in Go automatically "knows" that the Comment  /// struct implements the CommentService interface as all the method signatures "defined" for the interface are having "concrete // implementations" for the Comment struct. This is just how Go is. It's different from other languages.
...
// GetAllComment - retrieve all comments from database 
